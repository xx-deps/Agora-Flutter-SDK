...
abstract class RtcEngine {
  ...
  ///
  /// Before calling any APIs in the MediaPlayer class, you need to call this method to create an instance of the media player.
  ///
  /// Returns
...
enum MediaDeviceStateType {
  ...
  /// 9: The device is unplugged.
  @JsonValue(9)
  mediaDeviceStateSetAsDefault,
}
